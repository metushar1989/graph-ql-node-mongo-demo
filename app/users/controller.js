...
const createUser = (async (req, res) => {
    try {
        ...
        const userResp = await departmentService.createUser(body);
...
const updateUserById = (async (req, res) => {
    try {
        ...
        const userResp = await departmentService.updateUserById(body)
...
const getAllUser = (async (req, res) => {
    try {
        ...
        query.active = true
        const userResp = await departmentService.findUsers(query)
...
const deleteUser = (async (req, res) => {
    try {
        const body = req.body;
        const userResp = await departmentService.deleteUser(body.id)
